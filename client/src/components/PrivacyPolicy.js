  ...
  render() {
    return (
      <div>
        ...
        <h3>OVERVIEW</h3>
        <p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit or use the service Spare (the “Site”).</p>
        ...
        <h3>CONTACT US</h3>
        <p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at team@whatcanyouspare.org.</p>
      </div>
    )
  }
}
